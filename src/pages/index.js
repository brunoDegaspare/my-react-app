  ...
  <Layout>
    ...
    <div className="hero">
      <div className="hero__group">
        <h1 className="hero__heading">Learn how to <br/> design and code React apps.</h1>
        ...
        <Link className="hero__cta" to="/page-2/">Watch the Video</Link>
        ...
        <svg className="hero__waves" width="100%" height="172" fill="none">
          <path fill="white">
